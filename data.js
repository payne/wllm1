// LARC VEC content — sourced from larc-vec.org/becomeve.php
// Last updated: August 18, 2025

export const LARC_VEC_CONTENT = `
# Laurel Amateur Radio Club VEC — Volunteer Examiner Rules & Policies

Source: larc-vec.org — Laurel Amateur Radio Club Volunteer Examiner Coordinator
Administering FREE Amateur Radio License Exams since 1984
(Last site update: August 18, 2025)

---

## 1. About the Laurel VEC

The Laurel Amateur Radio Club (LARC) Volunteer Examiner Coordinator (VEC) — also known as the LARC VEC or Laurel VEC — is one of 14 VECs that have entered into an agreement with the Federal Communications Commission (FCC) to coordinate amateur radio examinations. It was established in 1984.

### Organizational Structure

- Chairman — Appointed by the Laurel Amateur Radio Club. Serves as point of contact with the FCC and is responsible for all aspects of the Laurel VEC.
- Regional Coordinators — Appointed by the Chairman. Recruit and manage VE teams within an assigned VEC Region.
- Team Leaders (Session Managers) — VEs who lead individual exam teams. Interface between the VE team, the sponsoring organization, and the VEC.
- Deputy Team Leaders — May conduct exam sessions when designated by the Team Leader.
- Volunteer Examiners (VEs) — Accredited by the Laurel VEC; perform all exam-related activities under the direction of the Team Leader.
...
1. Coordinate amateur radio license exam sessions conducted by accredited VE teams.
2. Provide policies, procedures, and instructions to ensure all exam-related activities comply with FCC rules and regulations.
3. Maintain the value and integrity of the Volunteer Examiner program.

Note: The policies, procedures, and instructions of the Laurel VEC are unique to the Laurel VEC. Policies of other VECs (ARRL, W5YI, etc.) do not apply to the Laurel VEC except as noted in Laurel VEC documents.

---

## 2. VE Qualifications (FCC §97.509(b))

To become an accredited Volunteer Examiner with the Laurel VEC, you must meet the minimum qualifications required by FCC Rules:

1. Be accredited by the coordinating VEC.
2. Be at least 18 years of age.
3. Hold an amateur operator license of the appropriate class:
   - Amateur Extra, Advanced, or General Class — to administer a Technician Class examination.
   - Amateur Extra or Advanced Class — to administer a General Class examination.
   - Amateur Extra Class — to administer an Amateur Extra Class examination.
4. Never have had an amateur station license or amateur operator license revoked or suspended.

---

## 3. How to Become a Laurel VEC Accredited VE

1. Find a team near you. The Laurel VEC does not accredit VEs on request alone — you must be associated with an active VE team. See the VE Teams page to find one.
2. Contact the Team Leader of a local team and ask if they need another VE. Acceptance is at the Team Leader's discretion.
3. The Team Leader nominates you to the Laurel VEC for accreditation. Upon approval, the Team Leader receives a VE accreditation certificate signed by the Laurel VEC Chairman and presents it to you.
4. Training. Once accredited, the Team Leader will train you and invite you to participate in exam sessions.

Existing VE teams from other VECs wishing to join the Laurel VEC should contact the appropriate Regional Coordinator.

---

## 4. VE Code of Conduct

All VEs accredited by the Laurel VEC are expected to comply with the following Code of Conduct. Failure to do so may result in dismissal from a team and/or revocation of accreditation.

### 4.1 General Conduct
- VEs must not act in any manner that would diminish the reputation of the LARC VEC or their team.
- VEs must comply with all FCC rules and regulations, Laurel VEC policies and procedures, and the instructions of Regional Coordinators.

### 4.2 Non-Discrimination
VEs must not discriminate against an applicant at any time or in any manner. This includes, but is not limited to, discrimination based on:
- Race
- Age
- Gender
- Religion
...
- Sexual orientation
- Their answer to the Basic Qualification (Felony) Question

The Laurel VEC also does not discriminate in accrediting VEs based on race, gender, sexual orientation, age, religion, national origin, or membership (or lack thereof) in any amateur radio organization.

### 4.3 Fees and Donations — STRICTLY PROHIBITED
- Laurel VEC accredited VEs may not, under any circumstance, charge a fee for administering examinations or for any other licensing-related services.
- VEs may not solicit or accept donations of any kind (monetary or non-monetary) from applicants.
- This policy has been in effect since the Laurel VEC's inception in 1984 and has never changed.
- VE team operating costs are typically funded by a sponsoring organization (e.g., a radio club) or shared among team members themselves.

The $35 FCC application fee is paid directly by the applicant to the FCC online. VE teams do not collect or handle this fee.

### 4.4 Reporting Violations
- If a VE believes a Team Leader is violating policies, the VE should notify the Regional Coordinator.
- If the Team Leader fails to correct the perceived violation, the VE should refuse to participate in an exam session where the violation is occurring.

---

## 5. Team Leader / Session Manager Responsibilities

### 5.1 Administrative
- Maintain up-to-date team information on the Laurel VEC website (via the VE Portal).
- Coordinate and advertise all scheduled exam sessions through the VE Portal.
- Notify the Regional Coordinator or VEC Chairman within 3 calendar days of any changes to Team Leader or Deputy Team Leader roles.
- Submit reports to the sponsoring organization describing test session results and participating VEs.
- Submit receipts for expenses (expendable supplies, printing, postage, etc.) to the sponsoring club for reimbursement as required.

### 5.2 Session Quality
- Ensure all session paperwork is 100% accurate, complete, and accounted for.
- Ensure all processes and procedures are completed in a timely manner — but never at the expense of accuracy.
- Contact the Regional Coordinator or VEC Chairman regarding any issue before, during, or after an exam session.

### 5.3 Coordination
- Coordinate with the sponsoring organization's leadership.
- Address and resolve known or suspected problems with Laurel VEC policies, the VEC website, or software tools by working with the Regional Coordinator or VEC Chairman.

---

## 6. Session Leader Responsibilities (During the Exam)

The Session Leader is the Laurel VEC accredited VE in charge of conducting an exam session. Typically this is the Team Leader, but a Deputy Team Leader may be designated.

1. The Session Leader ensures all session activities comply with:
   - FCC rules and instructions
   - Laurel VEC policies and instructions
   - Team policies and procedures
2. The Session Leader immediately addresses any issues raised by VEs during the session.

### 6.1 Handling Suspected Cheating
- If cheating is suspected but not confirmed, treat the applicant like any other applicant until confirmed.
- If cheating is confirmed:
  - Ask the examinee to step away from their testing area.
  - The two remaining VEs observe remaining examinees to ensure compliance.
  - Follow Laurel VEC procedures for documenting and reporting the incident.

---

## 7. VE Compliance and Enforcement

### 7.1 Consequences of Non-Compliance
Failure to comply with FCC rules and regulations, Laurel VEC policies and procedures, or Regional Coordinator instructions may result in:

1. Suspension or decertification of the VE Team.
2. Suspension or disaccreditation of individual VE status.
3. Referral to the FCC for appropriate action.

### 7.2 Reasons for VE Disaccreditation
The Laurel VEC may disaccredit VEs for reasons including (but not limited to):
- Violation of FCC Part 97 rules pertaining to VEs and exam administration.
- Violation of Laurel VEC policies, procedures, and instructions.
- Charging fees or soliciting/accepting donations from applicants.
- Discriminatory conduct.
- Any conduct that diminishes the integrity or reputation of the VEC or the exam program.

---

## 8. Exam Session Overview (for Reference)

### What to Bring (Applicants)
- Government-issued photo ID
- Original and copy of any element credit documentation (CSCE, expired license, etc.)
- Optional: calculator (memory must be cleared; cell phones not allowed)

### Session Flow
1. Registration — Complete application forms, show photo ID, provide element credit copies.
2. Pre-exam instructions — Calculator rules, conduct, retesting policy, bathroom breaks.
3. Exam — Technician/General: 35 questions, 26 correct to pass (74.2%). Amateur Extra: 50 questions, 37 correct to pass (74%).
4. Grading — Applicant is informed of results immediately.
5. CSCE issued — Passed applicants receive a Certificate of Successful Completion of Examination valid for 365 days.
6. Paperwork signed — VE team prepares, reviews, and signs application.
7. FCC submission — Laurel VEC submits to FCC. Licenses typically appear in the FCC ULS database the next business day after the applicant pays the $35 FCC application fee.

### Retesting Policy
- The decision to allow a retest within the same session after a failed attempt is entirely at the VE team's discretion.
- Factors considered: facility availability, session size, number of VEs, and margin of failure.

### Accommodations for Disabled Applicants
Per FCC §97.509(k), VEs must accommodate examinees whose physical disabilities require special procedures. These may include:
- Reading questions aloud.
- Marking the answer sheet on behalf of the examinee.
- Conducting a session at the applicant's home.

Applicants needing accommodations should contact the VE team in advance.

---

## 9. Online / Remote Exams

The Laurel VEC does not offer online (remote) testing. All examinees must be physically present with at least three administering VEs at all times.

---

## 10. Key FCC Application Fee Rules

Effective April 19, 2022, the FCC requires a $35 fee for:
...
- Name changes
- Contact information changes (address, email, phone)
- New sequentially-issued call signs

Warning: If the $35 fee is not paid within 10 calendar days of FCC receipt of the application, the application will be dismissed. Fees paid after 10 days are forfeited — no refunds.

---

## 11. Useful Resources

- Laurel VEC Home: https://larc-vec.org/home.php
- VE Portal (login required): https://portal.laurelvec.org/VE/login
- FCC ULS (look up licenses): https://www.fcc.gov/wireless/universal-licensing-system
...
- NCVEC Question Pools: http://ncvec.org
